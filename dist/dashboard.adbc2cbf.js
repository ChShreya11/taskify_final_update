...
const constructGraph = async (task)=>{
    const data = Object.keys(task.progressEachDay).map((date)=>({
        ...
        })).filter((obj)=>(0, _momentDefault.default)(obj.date, "DD/MM/YYYY").isSameOrBefore((0, _momentDefault.default)((0, _momentDefault.default)().format("DD/MM/YYYY"), "DD/MM/YYYY"))).sort((obj1, obj2)=>{
