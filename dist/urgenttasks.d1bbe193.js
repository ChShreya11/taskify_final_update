...
})({"dMpAu":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "81f8b926d1bbe193";
"use strict";
...
},{}],"iKi8F":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _auto = require("chart.js/auto");
var _autoDefault = parcelHelpers.interopDefault(_auto);
const moment = require("ffa40ea5d0fd074");
const lodash = require("a88a4e8c2172d9d5");
...
const updateUrgentTasksList = ()=>{
    ...
    const tasksArrayCopy = [
        ...tasksArray
    ];
    tasksArrayCopy.sort(sortByPriority);
    urgentTasksContainer.innerHTML = "";
    if (tasksArray.length === 0) {
        urgentTasksContainer.insertAdjacentHTML("beforeend", `<h1 style="text-align: center;">No urgent tasks available</h1>`);
        return;
    }
    tasksArrayCopy.forEach((task, index)=>{
        urgentTasksContainer.insertAdjacentHTML("beforeend", `<div class="urgent-tasks-details task-${index + 1}">
...
const constructGraph = async (task)=>{
    const data = Object.keys(task.progressEachDay).map((date)=>({
        ...
        })).filter((obj)=>moment(obj.date, "DD/MM/YYYY").isSameOrBefore(moment(moment().format("DD/MM/YYYY"), "DD/MM/YYYY"))).sort((obj1, obj2)=>{
...
},{"chart.js/auto":"d8NN9","ffa40ea5d0fd074":"jwcsj","a88a4e8c2172d9d5":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dMpAu","iKi8F"], "iKi8F", "parcelRequire19c4")

//# sourceMappingURL=urgenttasks.d1bbe193.js.map
