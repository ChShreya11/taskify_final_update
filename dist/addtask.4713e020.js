...
})({"3qph9":[function(require,module,exports) {
...
const moment = require("9034c5b7b162606");
...
(0, _tippyJsDefault.default)(".info-subtask", {
...
let duration = "";
let progressEachDay = {};
inputStartDate.setAttribute("min", `${moment(moment().format("YYYY-MM-DD"), "YYYY-MM-DD")._i}`);
inputEndDate.setAttribute("min", `${moment(moment().format("YYYY-MM-DD"), "YYYY-MM-DD")._i}`);
        ...
        case "weekly":
            {
                ...
                priorityDatePicker.insertAdjacentHTML("beforeend", `<label for="priority-date-picker__input">Pick a date:
                  <input
        ...
        case "biweekly":
            {
                ...
                const formattedStartDate = date.toISOString().split("T")[0];
                const formattedLastDate = lastDate.toISOString().split("T")[0];
                priorityDatePicker.insertAdjacentHTML("beforeend", `<label for="priority-date-picker__input">Pick first date:
                  <input
                    id="priority-date-picker__input"
                    type="date"
                    min=${formattedStartDate}
...
btnAddTask.addEventListener("click", ()=>{
    ...
    const recurringPeriod = recurringPeriodArray.find((element)=>element.checked).value;
    const duration = durationType.value;
    const progressEachDay = {};
    switch(priority){
        case "daily":
            let date = moment(moment(startDate, "YYYY-MM-DD").format("DD/MM/YYYY"), "DD/MM/YYYY");
            let lastDate = moment(moment(endDate, "YYYY-MM-DD").format("DD/MM/YYYY"), "DD/MM/YYYY");
            console.log(date);
        ...
        case "weekly":
            {
                let date = moment(moment(pickedFirstStartDate, "YYYY-MM-DD").format("DD/MM/YYYY"), "DD/MM/YYYY");
                let lastDate = moment(moment(endDate, "YYYY-MM-DD").format("DD/MM/YYYY"), "DD/MM/YYYY");
                while(date.isSameOrBefore(lastDate)){
                    progressEachDay[date.format("DD/MM/YYYY")] = 0;
                    date.add(7, "days");
        ...
        case "biweekly":
            {
                let firstDate = moment(moment(pickedFirstStartDate, "YYYY-MM-DD").format("DD/MM/YYYY"), "DD/MM/YYYY");
                let secondDate = moment(moment(pickedSecondStartDate, "YYYY-MM-DD").format("DD/MM/YYYY"), "DD/MM/YYYY");
                let lastDate = moment(moment(endDate, "YYYY-MM-DD").format("DD/MM/YYYY"), "DD/MM/YYYY");
...
formDiv.addEventListener("change", (event)=>{
    if (event.target.getAttribute("type") === "date") {
        ...
        if (date.getAttribute("id") === "sdate") startDate = inputStartDate.value;
        else endDate = inputEndDate.value;
    }
});
priorityDatePicker.addEventListener("change", ()=>{
    const datePickerArray = Array.from(priorityDatePicker.children).map((labelChild)=>Array.from(labelChild.children)[0]);
    console.log(datePickerArray);
    if (datePickerArray.length === 1) pickedFirstStartDate = datePickerArray[0].value;
    else {
...
},{"9034c5b7b162606":"jwcsj","tippy.js":"ccpCS","tippy.js/dist/tippy.css":"2hEyg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ccpCS":[function(require,module,exports) {
/**!
* tippy.js v6.3.7
* (c) 2017-2021 atomiks
* MIT License
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","./modifiers/offset.js":"3GKVY","./modifiers/flip.js":"fv5wq","./modifiers/preventOverflow.js":"1AMhb","./modifiers/arrow.js":"31HFW","./modifiers/hide.js":"2g4OF","./popper-lite.js":false,"./modifiers/index.js":false,"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2hEyg":[function() {},{}]},["3qph9","kexbG"], "kexbG", "parcelRequire19c4")

//# sourceMappingURL=addtask.4713e020.js.map
